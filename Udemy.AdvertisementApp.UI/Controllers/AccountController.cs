    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SignIn(AppUserLoginDto dto)
        {
            ...
            if (result.ResponseType == Common.ResponseType.Success)
            {
                ...
                {
                    if (roleResult.Data != null && roleResult.Data.Any())
                    {
                    ...
                    {
                        Console.WriteLine("Kullanıcı için roller bulunamadı.");
                    }
                }
                else
                {
                    Console.WriteLine("Roller alınırken hata oluştu: " + roleResult.Message);
                }
